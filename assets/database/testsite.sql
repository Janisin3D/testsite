...
--
-- Host: localhost    Database: testsite
-- ------------------------------------------------------
...
CREATE TABLE `watchdog` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-05-01 20:50:43
